; ============================================================================
; PC1-BMP.ASM (v 1.2) - BMP Image Viewer for Olivetti Prodest PC1
...
msg_info    db 'PC1-BMP v1.2 - BMP Image Viewer for Olivetti Prodest PC1', 0x0D, 0x0A
            db 0x0D, 0x0A
