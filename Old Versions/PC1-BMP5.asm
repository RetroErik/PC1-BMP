; ============================================================================
; PC1-BMP5.ASM (v 3.0) - BMP Viewer with Hero Technique + OUTSB/Skip Optim.
; ============================================================================
;
...
msg_info    db 'PC1-BMP5 v3.0 - Hero + OUTSB/Skip Optimized', 0x0D, 0x0A
            db 0x0D, 0x0A
            db 'Displays 320x200 4-bit BMP images using HBLANK', 0x0D, 0x0A
            db 'Hero palette technique, 0x44 start + OUTSB.', 0x0D, 0x0A
            db 0x0D, 0x0A
            db 'Usage: PC1-BMP5 filename.bmp', 0x0D, 0x0A
